...
pub use self::modest_status as modest_status_t;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct modest {
    pub mnode_obj: *mut mcobject_async_t,
    pub mnode_node_id: usize,
    pub mstylesheet_obj: *mut mcobject_async_t,
    pub mstylesheet_node_id: usize,
    pub mstyle_type_obj: *mut mchar_async_t,
    pub mstyle_type_node_id: usize,
    pub mraw_style_declaration_obj: *mut mcobject_t,
    pub layout: *mut modest_layout_t,
    pub style_avl_tree: *mut mycore_utils_avl_tree_t,
    pub myhtml_tree: *mut myhtml_tree_t,
    pub mycss_entry: *mut mycss_entry_t,
}
#[test]
fn bindgen_test_layout_modest() {
    assert_eq!(::std::mem::size_of::<modest>() , 88usize , concat ! (
               "Size of: " , stringify ! ( modest ) ));
    assert_eq! (::std::mem::align_of::<modest>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( modest ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mnode_obj as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mnode_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mnode_node_id as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mnode_node_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mstylesheet_obj as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mstylesheet_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mstylesheet_node_id as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mstylesheet_node_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mstyle_type_obj as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mstyle_type_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mstyle_type_node_id as *
                const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mstyle_type_node_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mraw_style_declaration_obj
                as * const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mraw_style_declaration_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . layout as * const _ as usize
                } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( layout ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . style_avl_tree as * const _
                as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( style_avl_tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . myhtml_tree as * const _ as
                usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( myhtml_tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest ) ) . mycss_entry as * const _ as
                usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( modest ) , "::" ,
                stringify ! ( mycss_entry ) ));
}
impl Clone for modest {
    fn clone(&self) -> Self { *self }
}
pub type modest_t = modest;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_node {
    _unused: [u8; 0],
}
pub type modest_node_t = modest_node;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_style_sheet {
    _unused: [u8; 0],
}
pub type modest_style_sheet_t = modest_style_sheet;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct modest_layer {
    pub next: *mut modest_layer_t,
    pub prev: *mut modest_layer_t,
    pub child: *mut modest_layer_t,
    pub parent: *mut modest_layer_t,
}
#[test]
fn bindgen_test_layout_modest_layer() {
    assert_eq!(::std::mem::size_of::<modest_layer>() , 32usize , concat ! (
               "Size of: " , stringify ! ( modest_layer ) ));
    assert_eq! (::std::mem::align_of::<modest_layer>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( modest_layer ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_layer ) ) . next as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_layer ) , "::" ,
                stringify ! ( next ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_layer ) ) . prev as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_layer ) , "::" ,
                stringify ! ( prev ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_layer ) ) . child as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_layer ) , "::" ,
                stringify ! ( child ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_layer ) ) . parent as * const _ as
                usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_layer ) , "::" ,
                stringify ! ( parent ) ));
}
impl Clone for modest_layer {
    fn clone(&self) -> Self { *self }
}
pub type modest_layer_t = modest_layer;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct modest_layout {
    pub mc_nodes: *mut mcobject_t,
}
#[test]
fn bindgen_test_layout_modest_layout() {
    assert_eq!(::std::mem::size_of::<modest_layout>() , 8usize , concat ! (
               "Size of: " , stringify ! ( modest_layout ) ));
    assert_eq! (::std::mem::align_of::<modest_layout>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( modest_layout ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_layout ) ) . mc_nodes as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_layout ) , "::"
                , stringify ! ( mc_nodes ) ));
}
impl Clone for modest_layout {
    fn clone(&self) -> Self { *self }
}
pub type modest_layout_t = modest_layout;
extern "C" {
    pub fn modest_layers_create() -> *mut modest_layout_t;
}
extern "C" {
    pub fn modest_layers_init(layout: *mut modest_layout_t) -> mystatus_t;
}
extern "C" {
    pub fn modest_layers_clean_all(layout: *mut modest_layout_t);
}
extern "C" {
    pub fn modest_layers_destroy(layout: *mut modest_layout_t,
                                 self_destroy: bool) -> *mut modest_layout_t;
}
extern "C" {
    pub fn modest_layer_create(layout: *mut modest_layout_t)
     -> *mut modest_layer_t;
}
extern "C" {
    pub fn modest_layer_clean(layer: *mut modest_layer_t);
}
extern "C" {
    pub fn modest_layer_destroy(layout: *mut modest_layout_t,
                                layer: *mut modest_layer_t)
     -> *mut modest_layer_t;
}
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mycore_utils_avl_tree {
    pub mc_nodes: *mut mcobject_t,
}
#[test]
fn bindgen_test_layout_mycore_utils_avl_tree() {
    assert_eq!(::std::mem::size_of::<mycore_utils_avl_tree>() , 8usize ,
               concat ! ( "Size of: " , stringify ! ( mycore_utils_avl_tree )
               ));
    assert_eq! (::std::mem::align_of::<mycore_utils_avl_tree>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( mycore_utils_avl_tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycore_utils_avl_tree ) ) . mc_nodes as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mycore_utils_avl_tree )
                , "::" , stringify ! ( mc_nodes ) ));
}
impl Clone for mycore_utils_avl_tree {
    fn clone(&self) -> Self { *self }
}
pub type mycore_utils_avl_tree_t = mycore_utils_avl_tree;
extern "C" {
    pub fn modest_create() -> *mut modest_t;
}
extern "C" {
    pub fn modest_init(modest: *mut modest_t) -> mystatus_t;
}
extern "C" {
    pub fn modest_clean(modest: *mut modest_t);
}
extern "C" {
    pub fn modest_destroy(modest: *mut modest_t, self_destroy: bool)
     -> *mut modest_t;
}
