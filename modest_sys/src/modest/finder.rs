...
pub struct mythread_queue_list_entry {
    pub queue: *mut mythread_queue_t,
    pub thread_param: *mut mythread_queue_thread_param_t,
    pub thread_param_size: usize,
    pub next: *mut mythread_queue_list_entry_t,
    pub prev: *mut mythread_queue_list_entry_t,
}
#[test]
fn bindgen_test_layout_mythread_queue_list_entry() {
    assert_eq!(::std::mem::size_of::<mythread_queue_list_entry>() , 40usize ,
               concat ! (
               "Size of: " , stringify ! ( mythread_queue_list_entry ) ));
    assert_eq! (::std::mem::align_of::<mythread_queue_list_entry>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( mythread_queue_list_entry )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_list_entry ) ) . queue as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                mythread_queue_list_entry ) , "::" , stringify ! ( queue ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_list_entry ) ) .
                thread_param as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                mythread_queue_list_entry ) , "::" , stringify ! (
                thread_param ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_list_entry ) ) .
                thread_param_size as * const _ as usize } , 16usize , concat !
                (
                "Alignment of field: " , stringify ! (
                mythread_queue_list_entry ) , "::" , stringify ! (
                thread_param_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_list_entry ) ) . next as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! (
                mythread_queue_list_entry ) , "::" , stringify ! ( next ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_list_entry ) ) . prev as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! (
                mythread_queue_list_entry ) , "::" , stringify ! ( prev ) ));
}
impl Clone for mythread_queue_list_entry {
...
#[test]
fn bindgen_test_layout_mythread_queue_thread_param() {
    assert_eq!(::std::mem::size_of::<mythread_queue_thread_param>() , 8usize ,
               concat ! (
               "Size of: " , stringify ! ( mythread_queue_thread_param ) ));
    assert_eq! (::std::mem::align_of::<mythread_queue_thread_param>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( mythread_queue_thread_param )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_thread_param ) ) . use_ as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                mythread_queue_thread_param ) , "::" , stringify ! ( use_ )
                ));
}
impl Clone for mythread_queue_thread_param {
    fn clone(&self) -> Self { *self }
}
...
pub struct mythread_queue_node {
    ...
    pub prev: *mut mythread_queue_node_t,
}
#[test]
fn bindgen_test_layout_mythread_queue_node() {
    assert_eq!(::std::mem::size_of::<mythread_queue_node>() , 24usize , concat
               ! ( "Size of: " , stringify ! ( mythread_queue_node ) ));
    assert_eq! (::std::mem::align_of::<mythread_queue_node>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( mythread_queue_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_node ) ) . context as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue_node ) ,
                "::" , stringify ! ( context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_node ) ) . args as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue_node ) ,
                "::" , stringify ! ( args ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue_node ) ) . prev as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue_node ) ,
                "::" , stringify ! ( prev ) ));
}
impl Clone for mythread_queue_node {
    fn clone(&self) -> Self { *self }
}
...
pub struct mythread_queue {
    pub nodes: *mut *mut mythread_queue_node_t,
    pub nodes_pos: usize,
    pub nodes_pos_size: usize,
    pub nodes_length: usize,
    pub nodes_uses: usize,
    pub nodes_size: usize,
    pub nodes_root: usize,
}
#[test]
fn bindgen_test_layout_mythread_queue() {
    assert_eq!(::std::mem::size_of::<mythread_queue>() , 56usize , concat ! (
               "Size of: " , stringify ! ( mythread_queue ) ));
    assert_eq! (::std::mem::align_of::<mythread_queue>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( mythread_queue ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_pos as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_pos ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_pos_size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_pos_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_length as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_uses as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_uses ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_size as *
                const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_queue ) ) . nodes_root as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_queue ) , "::"
                , stringify ! ( nodes_root ) ));
}
impl Clone for mythread_queue {
    fn clone(&self) -> Self { *self }
}
...
pub struct mythread_context {
    pub id: mythread_id_t,
    pub func: mythread_work_f,
    pub t_count: usize,
    pub opt: mythread_thread_opt_t,
    pub status: mystatus_t,
    pub mutex: *mut ::std::os::raw::c_void,
    pub timespec: *mut ::std::os::raw::c_void,
    pub mythread: *mut mythread_t,
}
#[test]
fn bindgen_test_layout_mythread_context() {
    assert_eq!(::std::mem::size_of::<mythread_context>() , 56usize , concat !
               ( "Size of: " , stringify ! ( mythread_context ) ));
    assert_eq! (::std::mem::align_of::<mythread_context>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( mythread_context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . id as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . func as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( func ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . t_count as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( t_count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . opt as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( opt ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . status as * const
                _ as usize } , 28usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( status ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . mutex as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( mutex ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . timespec as *
                const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( timespec ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_context ) ) . mythread as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_context ) ,
                "::" , stringify ! ( mythread ) ));
}
impl Clone for mythread_context {
    fn clone(&self) -> Self { *self }
}
...
pub struct mythread_entry {
    ...
    pub context: mythread_context_t,
    pub process_func: mythread_process_f,
}
#[test]
fn bindgen_test_layout_mythread_entry() {
    assert_eq!(::std::mem::size_of::<mythread_entry>() , 72usize , concat ! (
               "Size of: " , stringify ! ( mythread_entry ) ));
    assert_eq! (::std::mem::align_of::<mythread_entry>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( mythread_entry ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_entry ) ) . thread as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_entry ) , "::"
                , stringify ! ( thread ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_entry ) ) . context as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_entry ) , "::"
                , stringify ! ( context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread_entry ) ) . process_func as *
                const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread_entry ) , "::"
                , stringify ! ( process_func ) ));
}
impl Clone for mythread_entry {
    fn clone(&self) -> Self { *self }
}
...
#[derive(Debug, Copy)]
pub struct mythread {
    pub entries: *mut mythread_entry_t,
    pub entries_length: usize,
    pub entries_size: usize,
    pub id_increase: usize,
    pub context: *mut ::std::os::raw::c_void,
    pub attr: *mut ::std::os::raw::c_void,
    pub timespec: *mut ::std::os::raw::c_void,
    pub sys_last_error: ::std::os::raw::c_int,
    pub type_: mythread_type_t,
    pub opt: mythread_thread_opt_t,
}
#[test]
fn bindgen_test_layout_mythread() {
    assert_eq!(::std::mem::size_of::<mythread>() , 72usize , concat ! (
               "Size of: " , stringify ! ( mythread ) ));
    assert_eq! (::std::mem::align_of::<mythread>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( mythread ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . entries as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( entries ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . entries_length as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( entries_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . entries_size as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( entries_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . id_increase as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( id_increase ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . context as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . attr as * const _ as usize
                } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( attr ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . timespec as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( timespec ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . sys_last_error as * const
                _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( sys_last_error ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . type_ as * const _ as
                usize } , 60usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( type_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mythread ) ) . opt as * const _ as usize
                } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( mythread ) , "::" ,
                stringify ! ( opt ) ));
}
impl Clone for mythread {
    fn clone(&self) -> Self { *self }
}
...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_temp_tag_name {
    pub data: *mut ::std::os::raw::c_char,
    pub length: usize,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_myhtml_tree_temp_tag_name() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_temp_tag_name>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( myhtml_tree_temp_tag_name ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_temp_tag_name>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( myhtml_tree_temp_tag_name )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_temp_tag_name ) ) . data as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_temp_tag_name ) , "::" , stringify ! ( data ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_temp_tag_name ) ) . length as
                * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_temp_tag_name ) , "::" , stringify ! ( length )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_temp_tag_name ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_temp_tag_name ) , "::" , stringify ! ( size ) ));
}
impl Clone for myhtml_tree_temp_tag_name {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_temp_tag_name_t = myhtml_tree_temp_tag_name;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_insertion_list {
    pub list: *mut myhtml_insertion_mode,
    pub length: usize,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_myhtml_tree_insertion_list() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_insertion_list>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( myhtml_tree_insertion_list ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_insertion_list>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( myhtml_tree_insertion_list )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_insertion_list ) ) . list as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_insertion_list ) , "::" , stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_insertion_list ) ) . length
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_insertion_list ) , "::" , stringify ! ( length )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_insertion_list ) ) . size as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_tree_insertion_list ) , "::" , stringify ! ( size ) ));
}
impl Clone for myhtml_tree_insertion_list {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_insertion_list_t = myhtml_tree_insertion_list;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_token_list {
    pub list: *mut *mut myhtml_token_node_t,
    pub length: usize,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_myhtml_tree_token_list() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_token_list>() , 24usize ,
               concat ! ( "Size of: " , stringify ! ( myhtml_tree_token_list )
               ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_token_list>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( myhtml_tree_token_list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_token_list ) ) . list as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_token_list
                ) , "::" , stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_token_list ) ) . length as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_token_list
                ) , "::" , stringify ! ( length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_token_list ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_token_list
                ) , "::" , stringify ! ( size ) ));
}
impl Clone for myhtml_tree_token_list {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_token_list_t = myhtml_tree_token_list;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_list {
    pub list: *mut *mut myhtml_tree_node_t,
    pub length: usize,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_myhtml_tree_list() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_list>() , 24usize , concat !
               ( "Size of: " , stringify ! ( myhtml_tree_list ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_list>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( myhtml_tree_list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_list ) ) . list as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_list ) ,
                "::" , stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_list ) ) . length as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_list ) ,
                "::" , stringify ! ( length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_list ) ) . size as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_list ) ,
                "::" , stringify ! ( size ) ));
}
impl Clone for myhtml_tree_list {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_list_t = myhtml_tree_list;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_doctype {
    pub is_html: bool,
    pub attr_name: *mut ::std::os::raw::c_char,
    pub attr_public: *mut ::std::os::raw::c_char,
    pub attr_system: *mut ::std::os::raw::c_char,
}
#[test]
fn bindgen_test_layout_myhtml_tree_doctype() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_doctype>() , 32usize , concat
               ! ( "Size of: " , stringify ! ( myhtml_tree_doctype ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_doctype>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( myhtml_tree_doctype ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_doctype ) ) . is_html as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_doctype ) ,
                "::" , stringify ! ( is_html ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_doctype ) ) . attr_name as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_doctype ) ,
                "::" , stringify ! ( attr_name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_doctype ) ) . attr_public as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_doctype ) ,
                "::" , stringify ! ( attr_public ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_doctype ) ) . attr_system as
                * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_doctype ) ,
                "::" , stringify ! ( attr_system ) ));
}
impl Clone for myhtml_tree_doctype {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_doctype_t = myhtml_tree_doctype;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_async_args {
    pub mchar_node_id: usize,
}
#[test]
fn bindgen_test_layout_myhtml_async_args() {
    assert_eq!(::std::mem::size_of::<myhtml_async_args>() , 8usize , concat !
               ( "Size of: " , stringify ! ( myhtml_async_args ) ));
    assert_eq! (::std::mem::align_of::<myhtml_async_args>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( myhtml_async_args ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_async_args ) ) . mchar_node_id as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_async_args ) ,
                "::" , stringify ! ( mchar_node_id ) ));
}
impl Clone for myhtml_async_args {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_async_args_t = myhtml_async_args;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_tree_node {
    pub flags: myhtml_tree_node_flags,
    pub tag_id: myhtml_tag_id_t,
    pub ns: myhtml_namespace,
    pub prev: *mut myhtml_tree_node_t,
    pub next: *mut myhtml_tree_node_t,
    pub child: *mut myhtml_tree_node_t,
    pub parent: *mut myhtml_tree_node_t,
    pub last_child: *mut myhtml_tree_node_t,
    pub token: *mut myhtml_token_node_t,
    pub data: *mut ::std::os::raw::c_void,
    pub tree: *mut myhtml_tree_t,
}
#[test]
fn bindgen_test_layout_myhtml_tree_node() {
    assert_eq!(::std::mem::size_of::<myhtml_tree_node>() , 88usize , concat !
               ( "Size of: " , stringify ! ( myhtml_tree_node ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree_node>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( myhtml_tree_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . flags as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . tag_id as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( tag_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . ns as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( ns ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . prev as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( prev ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . next as * const _
                as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( next ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . child as * const _
                as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( child ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . parent as * const
                _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( parent ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . last_child as *
                const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( last_child ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . token as * const _
                as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( token ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . data as * const _
                as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( data ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree_node ) ) . tree as * const _
                as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree_node ) ,
                "::" , stringify ! ( tree ) ));
}
impl Clone for myhtml_tree_node {
    fn clone(&self) -> Self { *self }
}
...
pub struct myhtml_tree {
    pub myhtml: *mut myhtml_t,
    pub mchar: *mut mchar_async_t,
    pub token: *mut myhtml_token_t,
    pub tree_obj: *mut mcobject_async_t,
    pub sync: *mut mcsync_t,
    pub queue_entry: *mut mythread_queue_list_entry_t,
    pub queue: *mut mythread_queue_t,
    pub tags: *mut myhtml_tag_t,
    pub modest: *mut ::std::os::raw::c_void,
    pub context: *mut ::std::os::raw::c_void,
    pub mcasync_rules_token_id: usize,
    pub mcasync_rules_attr_id: usize,
    pub mcasync_tree_id: usize,
    pub mchar_node_id: usize,
    pub attr_current: *mut myhtml_token_attr_t,
    pub tmp_tag_id: myhtml_tag_id_t,
    pub current_token_node: *mut myhtml_token_node_t,
    pub current_qnode: *mut mythread_queue_node_t,
    pub mcobject_incoming_buf: *mut mcobject_t,
    pub incoming_buf: *mut mycore_incoming_buffer_t,
    pub incoming_buf_first: *mut mycore_incoming_buffer_t,
    pub document: *mut myhtml_tree_node_t,
    pub fragment: *mut myhtml_tree_node_t,
    pub node_head: *mut myhtml_tree_node_t,
    pub node_html: *mut myhtml_tree_node_t,
    pub node_body: *mut myhtml_tree_node_t,
    pub node_form: *mut myhtml_tree_node_t,
    pub doctype: myhtml_tree_doctype_t,
    pub active_formatting: *mut myhtml_tree_list_t,
    pub open_elements: *mut myhtml_tree_list_t,
    pub other_elements: *mut myhtml_tree_list_t,
    pub token_list: *mut myhtml_tree_token_list_t,
    pub template_insertion: *mut myhtml_tree_insertion_list_t,
    pub async_args: *mut myhtml_async_args_t,
    pub stream_buffer: *mut myhtml_stream_buffer_t,
    pub token_last_done: *mut myhtml_token_node_t,
    pub token_namespace: *mut myhtml_token_node_t,
    pub state: myhtml_tokenizer_state,
    pub state_of_builder: myhtml_tokenizer_state,
    pub insert_mode: myhtml_insertion_mode,
    pub orig_insert_mode: myhtml_insertion_mode,
    pub compat_mode: myhtml_tree_compat_mode,
    pub flags: myhtml_tree_flags,
    pub parse_flags: myhtml_tree_parse_flags_t,
    pub foster_parenting: bool,
    pub global_offset: usize,
    pub tokenizer_status: mystatus_t,
    pub encoding: myencoding_t,
    pub encoding_usereq: myencoding_t,
    pub temp_tag_name: myhtml_tree_temp_tag_name_t,
    pub callback_before_token: myhtml_callback_token_f,
    pub callback_after_token: myhtml_callback_token_f,
    pub callback_before_token_ctx: *mut ::std::os::raw::c_void,
    pub callback_after_token_ctx: *mut ::std::os::raw::c_void,
    pub callback_tree_node_insert: myhtml_callback_tree_node_f,
    pub callback_tree_node_remove: myhtml_callback_tree_node_f,
    pub callback_tree_node_insert_ctx: *mut ::std::os::raw::c_void,
    pub callback_tree_node_remove_ctx: *mut ::std::os::raw::c_void,
}
#[test]
fn bindgen_test_layout_myhtml_tree() {
    assert_eq!(::std::mem::size_of::<myhtml_tree>() , 464usize , concat ! (
               "Size of: " , stringify ! ( myhtml_tree ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tree>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( myhtml_tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . myhtml as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( myhtml ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mchar as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mchar ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . token as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( token ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . tree_obj as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( tree_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . sync as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( sync ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . queue_entry as * const
                _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( queue_entry ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . queue as * const _ as
                usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( queue ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . tags as * const _ as
                usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( tags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . modest as * const _ as
                usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( modest ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . context as * const _ as
                usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mcasync_rules_token_id
                as * const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mcasync_rules_token_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mcasync_rules_attr_id
                as * const _ as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mcasync_rules_attr_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mcasync_tree_id as *
                const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mcasync_tree_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mchar_node_id as *
                const _ as usize } , 104usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mchar_node_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . attr_current as * const
                _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( attr_current ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . tmp_tag_id as * const _
                as usize } , 120usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( tmp_tag_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . current_token_node as *
                const _ as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( current_token_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . current_qnode as *
                const _ as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( current_qnode ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . mcobject_incoming_buf
                as * const _ as usize } , 144usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( mcobject_incoming_buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . incoming_buf as * const
                _ as usize } , 152usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( incoming_buf ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . incoming_buf_first as *
                const _ as usize } , 160usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( incoming_buf_first ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . document as * const _
                as usize } , 168usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( document ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . fragment as * const _
                as usize } , 176usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( fragment ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . node_head as * const _
                as usize } , 184usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( node_head ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . node_html as * const _
                as usize } , 192usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( node_html ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . node_body as * const _
                as usize } , 200usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( node_body ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . node_form as * const _
                as usize } , 208usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( node_form ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . doctype as * const _ as
                usize } , 216usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( doctype ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . active_formatting as *
                const _ as usize } , 248usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( active_formatting ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . open_elements as *
                const _ as usize } , 256usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( open_elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . other_elements as *
                const _ as usize } , 264usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( other_elements ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . token_list as * const _
                as usize } , 272usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( token_list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . template_insertion as *
                const _ as usize } , 280usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( template_insertion ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . async_args as * const _
                as usize } , 288usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( async_args ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . stream_buffer as *
                const _ as usize } , 296usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( stream_buffer ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . token_last_done as *
                const _ as usize } , 304usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( token_last_done ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . token_namespace as *
                const _ as usize } , 312usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( token_namespace ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . state as * const _ as
                usize } , 320usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( state ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . state_of_builder as *
                const _ as usize } , 324usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( state_of_builder ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . insert_mode as * const
                _ as usize } , 328usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( insert_mode ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . orig_insert_mode as *
                const _ as usize } , 332usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( orig_insert_mode ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . compat_mode as * const
                _ as usize } , 336usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( compat_mode ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . flags as * const _ as
                usize } , 340usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . parse_flags as * const
                _ as usize } , 344usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( parse_flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . foster_parenting as *
                const _ as usize } , 348usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( foster_parenting ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . global_offset as *
                const _ as usize } , 352usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( global_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . tokenizer_status as *
                const _ as usize } , 360usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( tokenizer_status ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . encoding as * const _
                as usize } , 364usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( encoding ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . encoding_usereq as *
                const _ as usize } , 368usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( encoding_usereq ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . temp_tag_name as *
                const _ as usize } , 376usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( temp_tag_name ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . callback_before_token
                as * const _ as usize } , 400usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_before_token ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) . callback_after_token as
                * const _ as usize } , 408usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_after_token ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_before_token_ctx as * const _ as usize } , 416usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_before_token_ctx ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_after_token_ctx as * const _ as usize } , 424usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_after_token_ctx ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_tree_node_insert as * const _ as usize } , 432usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_tree_node_insert ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_tree_node_remove as * const _ as usize } , 440usize ,
                concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_tree_node_remove ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_tree_node_insert_ctx as * const _ as usize } ,
                448usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_tree_node_insert_ctx ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tree ) ) .
                callback_tree_node_remove_ctx as * const _ as usize } ,
                456usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tree ) , "::" ,
                stringify ! ( callback_tree_node_remove_ctx ) ));
}
impl Clone for myhtml_tree {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tree_t = myhtml_tree;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum myhtml_token_type {
...
pub struct myhtml_token_attr {
    pub next: *mut myhtml_token_attr_t,
    pub prev: *mut myhtml_token_attr_t,
    pub key: mycore_string_t,
    pub value: mycore_string_t,
    pub raw_key_begin: usize,
    pub raw_key_length: usize,
    pub raw_value_begin: usize,
    pub raw_value_length: usize,
    pub ns: myhtml_namespace,
}
#[test]
fn bindgen_test_layout_myhtml_token_attr() {
    assert_eq!(::std::mem::size_of::<myhtml_token_attr>() , 136usize , concat
               ! ( "Size of: " , stringify ! ( myhtml_token_attr ) ));
    assert_eq! (::std::mem::align_of::<myhtml_token_attr>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( myhtml_token_attr ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . next as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( next ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . prev as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( prev ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . key as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( key ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . value as * const
                _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( value ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . raw_key_begin as
                * const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( raw_key_begin ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . raw_key_length as
                * const _ as usize } , 104usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( raw_key_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . raw_value_begin
                as * const _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( raw_value_begin ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . raw_value_length
                as * const _ as usize } , 120usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( raw_value_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_attr ) ) . ns as * const _
                as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_attr ) ,
                "::" , stringify ! ( ns ) ));
}
impl Clone for myhtml_token_attr {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_token_attr_t = myhtml_token_attr;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_token_node {
    pub tag_id: myhtml_tag_id_t,
    pub str: mycore_string_t,
    pub raw_begin: usize,
    pub raw_length: usize,
    pub element_begin: usize,
    pub element_length: usize,
    pub attr_first: *mut myhtml_token_attr_t,
    pub attr_last: *mut myhtml_token_attr_t,
    pub type_: myhtml_token_type,
}
#[test]
fn bindgen_test_layout_myhtml_token_node() {
    assert_eq!(::std::mem::size_of::<myhtml_token_node>() , 104usize , concat
               ! ( "Size of: " , stringify ! ( myhtml_token_node ) ));
    assert_eq! (::std::mem::align_of::<myhtml_token_node>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( myhtml_token_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . tag_id as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( tag_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . str as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( str ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . raw_begin as *
                const _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( raw_begin ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . raw_length as *
                const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( raw_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . element_begin as
                * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( element_begin ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . element_length as
                * const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( element_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . attr_first as *
                const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( attr_first ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . attr_last as *
                const _ as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( attr_last ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token_node ) ) . type_ as * const
                _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token_node ) ,
                "::" , stringify ! ( type_ ) ));
}
impl Clone for myhtml_token_node {
    fn clone(&self) -> Self { *self }
}
...
pub struct myhtml_token {
    pub tree: *mut myhtml_tree_t,
    pub nodes_obj: *mut mcobject_async_t,
    pub attr_obj: *mut mcobject_async_t,
    pub mcasync_token_id: usize,
    pub mcasync_attr_id: usize,
    pub is_new_tmp: bool,
}
#[test]
fn bindgen_test_layout_myhtml_token() {
    assert_eq!(::std::mem::size_of::<myhtml_token>() , 48usize , concat ! (
               "Size of: " , stringify ! ( myhtml_token ) ));
    assert_eq! (::std::mem::align_of::<myhtml_token>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( myhtml_token ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . tree as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . nodes_obj as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( nodes_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . attr_obj as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( attr_obj ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . mcasync_token_id as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( mcasync_token_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . mcasync_attr_id as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( mcasync_attr_id ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_token ) ) . is_new_tmp as * const
                _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_token ) , "::" ,
                stringify ! ( is_new_tmp ) ));
}
impl Clone for myhtml_token {
    fn clone(&self) -> Self { *self }
}
...
pub struct myhtml_tag {
    pub tree: *mut mctree_t,
    pub mcsimple_context: *mut mcsimple_t,
    pub tags_count: usize,
    pub mchar_node: usize,
    pub mchar: *mut mchar_async_t,
}
#[test]
fn bindgen_test_layout_myhtml_tag() {
    assert_eq!(::std::mem::size_of::<myhtml_tag>() , 40usize , concat ! (
               "Size of: " , stringify ! ( myhtml_tag ) ));
    assert_eq! (::std::mem::align_of::<myhtml_tag>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( myhtml_tag ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tag ) ) . tree as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tag ) , "::" ,
                stringify ! ( tree ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tag ) ) . mcsimple_context as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tag ) , "::" ,
                stringify ! ( mcsimple_context ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tag ) ) . tags_count as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tag ) , "::" ,
                stringify ! ( tags_count ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tag ) ) . mchar_node as * const _
                as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tag ) , "::" ,
                stringify ! ( mchar_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_tag ) ) . mchar as * const _ as
                usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_tag ) , "::" ,
                stringify ! ( mchar ) ));
}
impl Clone for myhtml_tag {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_tag_t = myhtml_tag;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_stream_buffer_entry {
    pub data: *mut ::std::os::raw::c_char,
    pub length: usize,
    pub size: usize,
}
#[test]
fn bindgen_test_layout_myhtml_stream_buffer_entry() {
    assert_eq!(::std::mem::size_of::<myhtml_stream_buffer_entry>() , 24usize ,
               concat ! (
               "Size of: " , stringify ! ( myhtml_stream_buffer_entry ) ));
    assert_eq! (::std::mem::align_of::<myhtml_stream_buffer_entry>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( myhtml_stream_buffer_entry )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer_entry ) ) . data as
                * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_stream_buffer_entry ) , "::" , stringify ! ( data ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer_entry ) ) . length
                as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_stream_buffer_entry ) , "::" , stringify ! ( length )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer_entry ) ) . size as
                * const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! (
                myhtml_stream_buffer_entry ) , "::" , stringify ! ( size ) ));
}
impl Clone for myhtml_stream_buffer_entry {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_stream_buffer_entry_t = myhtml_stream_buffer_entry;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct myhtml_stream_buffer {
    pub entries: *mut myhtml_stream_buffer_entry_t,
    pub length: usize,
    pub size: usize,
    pub res: myencoding_result_t,
}
#[test]
fn bindgen_test_layout_myhtml_stream_buffer() {
    assert_eq!(::std::mem::size_of::<myhtml_stream_buffer>() , 72usize ,
               concat ! ( "Size of: " , stringify ! ( myhtml_stream_buffer )
               ));
    assert_eq! (::std::mem::align_of::<myhtml_stream_buffer>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( myhtml_stream_buffer ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer ) ) . entries as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_stream_buffer )
                , "::" , stringify ! ( entries ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer ) ) . length as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_stream_buffer )
                , "::" , stringify ! ( length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_stream_buffer )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml_stream_buffer ) ) . res as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml_stream_buffer )
                , "::" , stringify ! ( res ) ));
}
impl Clone for myhtml_stream_buffer {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_stream_buffer_t = myhtml_stream_buffer;
pub const myhtml_tokenizer_state_MyHTML_TOKENIZER_STATE_FIRST_ENTRY:
          myhtml_tokenizer_state =
    myhtml_tokenizer_state::MyHTML_TOKENIZER_STATE_DATA;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum myhtml_tokenizer_state {
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum myhtml_insertion_mode {
...
#[derive(Debug, Copy)]
pub struct myhtml {
    pub thread_stream: *mut mythread_t,
    pub thread_batch: *mut mythread_t,
    pub thread_list: [*mut mythread_t; 3usize],
    pub thread_total: usize,
    pub parse_state_func: *mut myhtml_tokenizer_state_f,
    pub insertion_func: *mut myhtml_insertion_f,
    pub opt: myhtml_options,
    pub marker: *mut myhtml_tree_node_t,
}
#[test]
fn bindgen_test_layout_myhtml() {
    assert_eq!(::std::mem::size_of::<myhtml>() , 80usize , concat ! (
               "Size of: " , stringify ! ( myhtml ) ));
    assert_eq! (::std::mem::align_of::<myhtml>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( myhtml ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . thread_stream as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( thread_stream ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . thread_batch as * const _ as
                usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( thread_batch ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . thread_list as * const _ as
                usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( thread_list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . thread_total as * const _ as
                usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( thread_total ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . parse_state_func as * const
                _ as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( parse_state_func ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . insertion_func as * const _
                as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( insertion_func ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . opt as * const _ as usize }
                , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( opt ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myhtml ) ) . marker as * const _ as usize
                } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( myhtml ) , "::" ,
                stringify ! ( marker ) ));
}
impl Clone for myhtml {
    fn clone(&self) -> Self { *self }
}
pub type myhtml_t = myhtml;
pub type myhtml_tokenizer_state_f =
    ::std::option::Option<unsafe extern "C" fn(tree: *mut myhtml_tree_t,
                                               ...
                                               html_offset: usize,
                                               html_size: usize) -> usize>;
pub type myhtml_insertion_f =
    ::std::option::Option<unsafe extern "C" fn(tree: *mut myhtml_tree_t,
                                               token:
                                                   *mut myhtml_token_node_t)
                              -> bool>;
...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mcobject_async_chunk {
    pub begin: *mut ::std::os::raw::c_uchar,
    pub length: usize,
    pub size: usize,
    pub next: *mut mcobject_async_chunk,
    pub prev: *mut mcobject_async_chunk,
}
#[test]
fn bindgen_test_layout_mcobject_async_chunk() {
    assert_eq!(::std::mem::size_of::<mcobject_async_chunk>() , 40usize ,
               concat ! ( "Size of: " , stringify ! ( mcobject_async_chunk )
               ));
    assert_eq! (::std::mem::align_of::<mcobject_async_chunk>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( mcobject_async_chunk ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_chunk ) ) . begin as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_chunk )
                , "::" , stringify ! ( begin ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_chunk ) ) . length as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_chunk )
                , "::" , stringify ! ( length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_chunk ) ) . size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_chunk )
                , "::" , stringify ! ( size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_chunk ) ) . next as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_chunk )
                , "::" , stringify ! ( next ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_chunk ) ) . prev as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_chunk )
                , "::" , stringify ! ( prev ) ));
}
impl Clone for mcobject_async_chunk {
    fn clone(&self) -> Self { *self }
}
pub type mcobject_async_chunk_t = mcobject_async_chunk;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mcobject_async_node {
    pub chunk: *mut mcobject_async_chunk_t,
    pub cache: *mut *mut ::std::os::raw::c_void,
    pub cache_size: usize,
    pub cache_length: usize,
}
#[test]
fn bindgen_test_layout_mcobject_async_node() {
    assert_eq!(::std::mem::size_of::<mcobject_async_node>() , 32usize , concat
               ! ( "Size of: " , stringify ! ( mcobject_async_node ) ));
    assert_eq! (::std::mem::align_of::<mcobject_async_node>() , 8usize ,
                concat ! (
                "Alignment of " , stringify ! ( mcobject_async_node ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_node ) ) . chunk as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_node ) ,
                "::" , stringify ! ( chunk ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_node ) ) . cache as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_node ) ,
                "::" , stringify ! ( cache ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_node ) ) . cache_size as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_node ) ,
                "::" , stringify ! ( cache_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async_node ) ) . cache_length as
                * const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async_node ) ,
                "::" , stringify ! ( cache_length ) ));
}
impl Clone for mcobject_async_node {
    fn clone(&self) -> Self { *self }
}
pub type mcobject_async_node_t = mcobject_async_node;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mcobject_async {
    pub origin_size: usize,
    pub struct_size: usize,
    pub struct_size_sn: usize,
    pub chunk_cache: *mut *mut mcobject_async_chunk_t,
    pub chunk_cache_size: usize,
    pub chunk_cache_length: usize,
    pub chunks: *mut *mut mcobject_async_chunk_t,
    pub chunks_pos_size: usize,
    pub chunks_pos_length: usize,
    pub chunks_size: usize,
    pub chunks_length: usize,
    pub nodes: *mut mcobject_async_node_t,
    pub nodes_length: usize,
    pub nodes_size: usize,
...
#[test]
fn bindgen_test_layout_mcobject_async() {
    assert_eq!(::std::mem::size_of::<mcobject_async>() , 144usize , concat ! (
               "Size of: " , stringify ! ( mcobject_async ) ));
    assert_eq! (::std::mem::align_of::<mcobject_async>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( mcobject_async ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . origin_size as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( origin_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . struct_size as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( struct_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . struct_size_sn as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( struct_size_sn ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunk_cache as *
                const _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunk_cache ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunk_cache_size as
                * const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunk_cache_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunk_cache_length
                as * const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunk_cache_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunks as * const _
                as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunks ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunks_pos_size as *
                const _ as usize } , 56usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunks_pos_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunks_pos_length as
                * const _ as usize } , 64usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunks_pos_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunks_size as *
                const _ as usize } , 72usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunks_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . chunks_length as *
                const _ as usize } , 80usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( chunks_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes as * const _
                as usize } , 88usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes_length as *
                const _ as usize } , 96usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes_size as *
                const _ as usize } , 104usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes_cache as *
                const _ as usize } , 112usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes_cache ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes_cache_length
                as * const _ as usize } , 120usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes_cache_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . nodes_cache_size as
                * const _ as usize } , 128usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( nodes_cache_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcobject_async ) ) . mcsync as * const _
                as usize } , 136usize , concat ! (
                "Alignment of field: " , stringify ! ( mcobject_async ) , "::"
                , stringify ! ( mcsync ) ));
}
impl Clone for mcobject_async {
    fn clone(&self) -> Self { *self }
}
pub type mcobject_async_t = mcobject_async;
#[repr(C)]
#[derive(Debug, Copy)]
...
pub type mythread_process_f =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void)
                              -> *mut ::std::os::raw::c_void>;
pub type mythread_work_f =
    ::std::option::Option<unsafe extern "C" fn(thread_id: mythread_id_t,
                                               arg:
                                                   *mut ::std::os::raw::c_void)>;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mythread_thread_opt {
...
pub use self::mythread_thread_opt as mythread_thread_opt_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mythread_type { MyTHREAD_TYPE_STREAM = 0, MyTHREAD_TYPE_BATCH = 1, }
pub use self::mythread_type as mythread_type_t;
#[repr(C)]
#[derive(Debug, Copy)]
...
pub struct myencoding_result {
    ...
    pub third: ::std::os::raw::c_ulong,
    pub result: ::std::os::raw::c_ulong,
    pub result_aux: ::std::os::raw::c_ulong,
    pub flag: ::std::os::raw::c_ulong,
}
#[test]
fn bindgen_test_layout_myencoding_result() {
    assert_eq!(::std::mem::size_of::<myencoding_result>() , 48usize , concat !
               ( "Size of: " , stringify ! ( myencoding_result ) ));
    assert_eq! (::std::mem::align_of::<myencoding_result>() , 8usize , concat
                ! ( "Alignment of " , stringify ! ( myencoding_result ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . first as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( first ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . second as * const
                _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( second ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . third as * const
                _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( third ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . result as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( result ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . result_aux as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( result_aux ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const myencoding_result ) ) . flag as * const _
                as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( myencoding_result ) ,
                "::" , stringify ! ( flag ) ));
}
impl Clone for myencoding_result {
    fn clone(&self) -> Self { *self }
}
...
pub struct mcsimple {
    pub struct_size: usize,
    pub list: *mut *mut u8,
    pub list_pos_size: usize,
    pub list_pos_length: usize,
    pub list_pos_length_used: usize,
    pub list_size: usize,
    pub list_length: usize,
}
#[test]
fn bindgen_test_layout_mcsimple() {
    assert_eq!(::std::mem::size_of::<mcsimple>() , 56usize , concat ! (
               "Size of: " , stringify ! ( mcsimple ) ));
    assert_eq! (::std::mem::align_of::<mcsimple>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( mcsimple ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . struct_size as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( struct_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list as * const _ as usize
                } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list_pos_size as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list_pos_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list_pos_length as * const
                _ as usize } , 24usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list_pos_length ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list_pos_length_used as *
                const _ as usize } , 32usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list_pos_length_used ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list_size as * const _ as
                usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list_size ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mcsimple ) ) . list_length as * const _
                as usize } , 48usize , concat ! (
                "Alignment of field: " , stringify ! ( mcsimple ) , "::" ,
                stringify ! ( list_length ) ));
}
impl Clone for mcsimple {
    fn clone(&self) -> Self { *self }
}
pub type mcsimple_t = mcsimple;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum myhtml_tree_node_flags {
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum myhtml_tree_compat_mode {
...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct modest_finder {
    pub ctx: *mut ::std::os::raw::c_void,
}
#[test]
fn bindgen_test_layout_modest_finder() {
    assert_eq!(::std::mem::size_of::<modest_finder>() , 8usize , concat ! (
               "Size of: " , stringify ! ( modest_finder ) ));
    assert_eq! (::std::mem::align_of::<modest_finder>() , 8usize , concat ! (
                "Alignment of " , stringify ! ( modest_finder ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const modest_finder ) ) . ctx as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( modest_finder ) , "::"
                , stringify ! ( ctx ) ));
}
impl Clone for modest_finder {
    fn clone(&self) -> Self { *self }
}
pub type modest_finder_t = modest_finder;
pub type modest_finder_callback_f =
    ::std::option::Option<unsafe extern "C" fn(finder: *mut modest_finder_t,
                                               node: *mut myhtml_tree_node_t,
                                               selector_list:
                                               ...
                                               selector:
                                                   *mut mycss_selectors_entry_t,
                                               spec:
                                                   *mut mycss_selectors_specificity_t,
                                               ctx:
                                                   *mut ::std::os::raw::c_void)>;
pub type modest_finder_match_f =
    ::std::option::Option<unsafe extern "C" fn(attr: *mut myhtml_token_attr_t,
                                               key:
                                                   *const ::std::os::raw::c_char,
                                               key_len: usize,
                                               value:
...
pub struct modest_finder_thread_declaration {
    _unused: [u8; 0],
}
pub type modest_finder_thread_declaration_t =
    modest_finder_thread_declaration;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_finder_thread_entry {
    _unused: [u8; 0],
}
pub type modest_finder_thread_entry_t = modest_finder_thread_entry;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_finder_thread_context {
    _unused: [u8; 0],
}
pub type modest_finder_thread_context_t = modest_finder_thread_context;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_finder_thread {
    _unused: [u8; 0],
}
pub type modest_finder_thread_t = modest_finder_thread;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct modest_finder_thread_found_context {
    _unused: [u8; 0],
}
pub type modest_finder_thread_found_context_t =
    modest_finder_thread_found_context;
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_undef(finder:
                                                                           *mut modest_finder_t,
                                                                       base_node:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_current(finder:
                                                                             *mut modest_finder_t,
                                                                         base_node:
                                                                             *mut myhtml_tree_node_t,
                                                                         selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_dir(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_drop(finder:
                                                                          *mut modest_finder_t,
                                                                      base_node:
                                                                          *mut myhtml_tree_node_t,
                                                                      selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_has(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_lang(finder:
                                                                          *mut modest_finder_t,
                                                                      base_node:
                                                                          *mut myhtml_tree_node_t,
                                                                      selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_matches(finder:
                                                                             *mut modest_finder_t,
                                                                         base_node:
                                                                             *mut myhtml_tree_node_t,
                                                                         selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_not(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_child(finder:
                                                                               *mut modest_finder_t,
                                                                           base_node:
                                                                               *mut myhtml_tree_node_t,
                                                                           selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_column(finder:
                                                                                *mut modest_finder_t,
                                                                            base_node:
                                                                                *mut myhtml_tree_node_t,
                                                                            selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_last_child(finder:
                                                                                    *mut modest_finder_t,
                                                                                base_node:
                                                                                    *mut myhtml_tree_node_t,
                                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_last_column(finder:
                                                                                     *mut modest_finder_t,
                                                                                 base_node:
                                                                                     *mut myhtml_tree_node_t,
                                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_last_of_type(finder:
                                                                                      *mut modest_finder_t,
                                                                                  base_node:
                                                                                      *mut myhtml_tree_node_t,
                                                                                  selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_function_nth_of_type(finder:
                                                                                 *mut modest_finder_t,
                                                                             base_node:
                                                                                 *mut myhtml_tree_node_t,
                                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_undef(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_active(finder:
                                                                   *mut modest_finder_t,
                                                               base_node:
                                                                   *mut myhtml_tree_node_t,
                                                               selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_any_link(finder:
                                                                     *mut modest_finder_t,
                                                                 base_node:
                                                                     *mut myhtml_tree_node_t,
                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_blank(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_checked(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_current(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_default(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_disabled(finder:
                                                                     *mut modest_finder_t,
                                                                 base_node:
                                                                     *mut myhtml_tree_node_t,
                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_drop(finder:
                                                                 *mut modest_finder_t,
                                                             base_node:
                                                                 *mut myhtml_tree_node_t,
                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_empty(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_enabled(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_first_child(finder:
                                                                        *mut modest_finder_t,
                                                                    base_node:
                                                                        *mut myhtml_tree_node_t,
                                                                    selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_first_of_type(finder:
                                                                          *mut modest_finder_t,
                                                                      base_node:
                                                                          *mut myhtml_tree_node_t,
                                                                      selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_focus(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_future(finder:
                                                                   *mut modest_finder_t,
                                                               base_node:
                                                                   *mut myhtml_tree_node_t,
                                                               selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_hover(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_in_range(finder:
                                                                     *mut modest_finder_t,
                                                                 base_node:
                                                                     *mut myhtml_tree_node_t,
                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_indeterminate(finder:
                                                                          *mut modest_finder_t,
                                                                      base_node:
                                                                          *mut myhtml_tree_node_t,
                                                                      selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_invalid(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_last_child(finder:
                                                                       *mut modest_finder_t,
                                                                   base_node:
                                                                       *mut myhtml_tree_node_t,
                                                                   selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_last_of_type(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_link(finder:
                                                                 *mut modest_finder_t,
                                                             base_node:
                                                                 *mut myhtml_tree_node_t,
                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_only_child(finder:
                                                                       *mut modest_finder_t,
                                                                   base_node:
                                                                       *mut myhtml_tree_node_t,
                                                                   selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_only_of_type(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_optional(finder:
                                                                     *mut modest_finder_t,
                                                                 base_node:
                                                                     *mut myhtml_tree_node_t,
                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_out_of_range(finder:
                                                                         *mut modest_finder_t,
                                                                     base_node:
                                                                         *mut myhtml_tree_node_t,
                                                                     selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_past(finder:
                                                                 *mut modest_finder_t,
                                                             base_node:
                                                                 *mut myhtml_tree_node_t,
                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_placeholder_shown(finder:
                                                                              *mut modest_finder_t,
                                                                          base_node:
                                                                              *mut myhtml_tree_node_t,
                                                                          selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_read_only(finder:
                                                                      *mut modest_finder_t,
                                                                  base_node:
                                                                      *mut myhtml_tree_node_t,
                                                                  selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_read_write(finder:
                                                                       *mut modest_finder_t,
                                                                   base_node:
                                                                       *mut myhtml_tree_node_t,
                                                                   selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_required(finder:
                                                                     *mut modest_finder_t,
                                                                 base_node:
                                                                     *mut myhtml_tree_node_t,
                                                                 selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_root(finder:
                                                                 *mut modest_finder_t,
                                                             base_node:
                                                                 *mut myhtml_tree_node_t,
                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_scope(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_target(finder:
                                                                   *mut modest_finder_t,
                                                               base_node:
                                                                   *mut myhtml_tree_node_t,
                                                               selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_user_error(finder:
                                                                       *mut modest_finder_t,
                                                                   base_node:
                                                                       *mut myhtml_tree_node_t,
                                                                   selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_valid(finder:
                                                                  *mut modest_finder_t,
                                                              base_node:
                                                                  *mut myhtml_tree_node_t,
                                                              selector:
...
extern "C" {
    pub fn modest_finder_selector_sub_type_pseudo_class_visited(finder:
                                                                    *mut modest_finder_t,
                                                                base_node:
                                                                    *mut myhtml_tree_node_t,
                                                                selector:
...
extern "C" {
    pub fn modest_finder_match_attribute_only_key(attr:
                                                      *mut myhtml_token_attr_t,
                                                  key:
                                                      *const ::std::os::raw::c_char,
                                                  key_len: usize) -> bool;
}
extern "C" {
    pub fn modest_finder_match_attribute_eq(attr: *mut myhtml_token_attr_t,
                                            key:
                                                *const ::std::os::raw::c_char,
                                            key_len: usize,
                                            value:
...
extern "C" {
    pub fn modest_finder_match_attribute_ws(attr: *mut myhtml_token_attr_t,
                                            key:
                                                *const ::std::os::raw::c_char,
                                            key_len: usize,
                                            value:
...
extern "C" {
    pub fn modest_finder_match_attribute_begin(attr: *mut myhtml_token_attr_t,
                                               key:
                                                   *const ::std::os::raw::c_char,
                                               key_len: usize,
                                               value:
...
extern "C" {
    pub fn modest_finder_match_attribute_end(attr: *mut myhtml_token_attr_t,
                                             key:
                                                 *const ::std::os::raw::c_char,
                                             key_len: usize,
                                             value:
...
extern "C" {
    pub fn modest_finder_match_attribute_sub(attr: *mut myhtml_token_attr_t,
                                             key:
                                                 *const ::std::os::raw::c_char,
                                             key_len: usize,
                                             value:
...
extern "C" {
    pub fn modest_finder_match_attribute_hsp(attr: *mut myhtml_token_attr_t,
                                             key:
                                                 *const ::std::os::raw::c_char,
                                             key_len: usize,
                                             value:
...
extern "C" {
    pub fn modest_finder_selector_type_undef(finder: *mut modest_finder_t,
                                             node: *mut myhtml_tree_node_t,
                                             selector:
                                                 *mut mycss_selectors_entry_t,
                                             spec:
...
extern "C" {
    pub fn modest_finder_selector_type_element(finder: *mut modest_finder_t,
                                               node: *mut myhtml_tree_node_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t,
                                               spec:
...
extern "C" {
    pub fn modest_finder_selector_type_id(finder: *mut modest_finder_t,
                                          node: *mut myhtml_tree_node_t,
                                          selector:
                                              *mut mycss_selectors_entry_t,
                                          spec:
...
extern "C" {
    pub fn modest_finder_selector_type_class(finder: *mut modest_finder_t,
                                             node: *mut myhtml_tree_node_t,
                                             selector:
                                                 *mut mycss_selectors_entry_t,
                                             spec:
...
extern "C" {
    pub fn modest_finder_selector_type_attribute(finder: *mut modest_finder_t,
                                                 node:
                                                     *mut myhtml_tree_node_t,
                                                 selector:
                                                     *mut mycss_selectors_entry_t,
...
extern "C" {
    pub fn modest_finder_selector_type_pseudo_class_function(finder:
                                                                 *mut modest_finder_t,
                                                             node:
                                                                 *mut myhtml_tree_node_t,
                                                             selector:
...
extern "C" {
    pub fn modest_finder_selector_type_pseudo_class(finder:
                                                        *mut modest_finder_t,
                                                    node:
                                                        *mut myhtml_tree_node_t,
                                                    selector:
...
extern "C" {
    pub fn modest_finder_selector_type_pseudo_element_function(finder:
                                                                   *mut modest_finder_t,
                                                               node:
                                                                   *mut myhtml_tree_node_t,
                                                               selector:
...
extern "C" {
    pub fn modest_finder_selector_type_pseudo_element(finder:
                                                          *mut modest_finder_t,
                                                      node:
                                                          *mut myhtml_tree_node_t,
                                                      selector:
...
pub type modest_finder_selector_type_f =
    ::std::option::Option<unsafe extern "C" fn(finder: *mut modest_finder_t,
                                               node: *mut myhtml_tree_node_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t,
                                               spec:
                                                   *mut mycss_selectors_specificity_t)
                              -> bool>;
pub type modest_finder_selector_combinator_f =
    ::std::option::Option<unsafe extern "C" fn(finder: *mut modest_finder_t,
                                               node: *mut myhtml_tree_node_t,
                                               selector_list:
                                                   *mut mycss_selectors_list_t,
                              ...
                              -> *mut myhtml_tree_node_t>;
extern "C" {
    pub fn modest_finder_create() -> *mut modest_finder_t;
}
extern "C" {
    pub fn modest_finder_init(finder: *mut modest_finder_t) -> mystatus_t;
}
extern "C" {
    pub fn modest_finder_clean(finder: *mut modest_finder_t);
}
extern "C" {
    pub fn modest_finder_destroy(finder: *mut modest_finder_t,
                                 self_destroy: bool) -> *mut modest_finder_t;
}
extern "C" {
    pub fn modest_finder_create_simple() -> *mut modest_finder_t;
}
extern "C" {
    pub fn modest_finder_callback_found_with_collection(finder:
                                                            *mut modest_finder_t,
                                                        node:
                                                            *mut myhtml_tree_node_t,
                                                        selector_list:
...
extern "C" {
    pub fn modest_finder_callback_found_with_bool(finder:
                                                      *mut modest_finder_t,
                                                  node:
                                                      *mut myhtml_tree_node_t,
                                                  selector_list:
...
extern "C" {
    pub fn modest_finder_specificity_inc(selector:
                                             *mut mycss_selectors_entry_t,
                                         spec:
                                             *mut mycss_selectors_specificity_t);
}
extern "C" {
    pub fn modest_finder_by_stylesheet(stylesheet: *mut mycss_stylesheet_t,
                                       collection:
                                           *mut *mut myhtml_collection_t,
                                       base_node: *mut myhtml_tree_node_t)
     -> *mut modest_finder_t;
}
extern "C" {
    pub fn modest_finder_by_selectors_list(finder: *mut modest_finder_t,
                                           scope_node:
                                               *mut myhtml_tree_node_t,
                                           selector_list:
                                               *mut mycss_selectors_list_t,
...
extern "C" {
    pub fn modest_finder_node_combinator_begin(finder: *mut modest_finder_t,
                                               base_node:
                                                   *mut myhtml_tree_node_t,
                                               selector_list:
                                                   *mut mycss_selectors_list_t,
...
extern "C" {
    pub fn modest_finder_node_combinator_undef(finder: *mut modest_finder_t,
                                               base_node:
                                                   *mut myhtml_tree_node_t,
                                               selector_list:
                                                   *mut mycss_selectors_list_t,
...
extern "C" {
    pub fn modest_finder_node_combinator_descendant(finder:
                                                        *mut modest_finder_t,
                                                    base_node:
                                                        *mut myhtml_tree_node_t,
                                                    selector_list:
...
extern "C" {
    pub fn modest_finder_node_combinator_child(finder: *mut modest_finder_t,
                                               base_node:
                                                   *mut myhtml_tree_node_t,
                                               selector_list:
                                                   *mut mycss_selectors_list_t,
...
extern "C" {
    pub fn modest_finder_node_combinator_next_sibling(finder:
                                                          *mut modest_finder_t,
                                                      base_node:
                                                          *mut myhtml_tree_node_t,
                                                      selector_list:
...
extern "C" {
    pub fn modest_finder_node_combinator_following_sibling(finder:
                                                               *mut modest_finder_t,
                                                           base_node:
                                                               *mut myhtml_tree_node_t,
                                                           selector_list:
...
extern "C" {
    pub fn modest_finder_node_combinator_column(finder: *mut modest_finder_t,
                                                base_node:
                                                    *mut myhtml_tree_node_t,
                                                selector_list:
                                                    *mut mycss_selectors_list_t,
