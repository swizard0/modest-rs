...
pub type mycss_selectors_state_f =
    ::std::option::Option<unsafe extern "C" fn(entry: *mut mycss_entry_t,
                                               selectors:
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_match {
...
pub use self::mycss_selectors_match as mycss_selectors_match_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_mod {
    MyCSS_SELECTORS_MOD_UNDEF = 0,
    MyCSS_SELECTORS_MOD_I = 1,
}
pub use self::mycss_selectors_mod as mycss_selectors_mod_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_sub_type {
    MyCSS_SELECTORS_SUB_TYPE_UNDEF = 0,
    MyCSS_SELECTORS_SUB_TYPE_UNKNOWN = 1,
}
pub use self::mycss_selectors_sub_type as mycss_selectors_sub_type_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_sub_type_pseudo_class_function {
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_UNDEF = 0,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_UNKNOWN = 1,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_CURRENT = 2,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_DIR = 3,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_DROP = 4,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_HAS = 5,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_LANG = 6,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_MATCHES = 7,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NOT = 8,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_CHILD = 9,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_COLUMN = 10,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_LAST_CHILD = 11,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_LAST_COLUMN = 12,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_LAST_OF_TYPE = 13,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_NTH_OF_TYPE = 14,
    MyCSS_SELECTORS_SUB_TYPE_PSEUDO_CLASS_FUNCTION_LAST_ENTRY = 15,
}
pub use self::mycss_selectors_sub_type_pseudo_class_function as
        mycss_selectors_sub_type_pseudo_class_function_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_sub_type_pseudo_class {
...
pub use self::mycss_selectors_sub_type_pseudo_class as
        mycss_selectors_sub_type_pseudo_class_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_sub_type_pseudo_element {
...
pub use self::mycss_selectors_sub_type_pseudo_element as
        mycss_selectors_sub_type_pseudo_element_t;
#[repr(u32)]
#[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
pub enum mycss_selectors_function_drop_type {
...
pub use self::mycss_selectors_function_drop_type as
        mycss_selectors_function_drop_type_t;
pub type mycss_selectors_value_destroy_f =
    ::std::option::Option<unsafe extern "C" fn(entry: *mut mycss_entry_t,
                                               type_: mycss_selectors_type_t,
                                               sub_type:
                                                   ::std::os::raw::c_int,
                                               value:
                                                   *mut ::std::os::raw::c_void,
                                               self_destroy: bool)
                              -> *mut ::std::os::raw::c_void>;
pub type mycss_selectors_value_function_destroy_f =
    ::std::option::Option<unsafe extern "C" fn(entry: *mut mycss_entry_t,
                                               value:
                                                   *mut ::std::os::raw::c_void,
                                               self_destroy: bool)
...
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mycss_selectors_value_attribute {
    pub value: *mut mycore_string_t,
    pub match_: mycss_selectors_match_t,
    pub mod_: mycss_selectors_mod_t,
}
#[test]
fn bindgen_test_layout_mycss_selectors_value_attribute() {
    assert_eq!(::std::mem::size_of::<mycss_selectors_value_attribute>() ,
               16usize , concat ! (
               "Size of: " , stringify ! ( mycss_selectors_value_attribute )
               ));
    assert_eq! (::std::mem::align_of::<mycss_selectors_value_attribute>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! (
                mycss_selectors_value_attribute ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_value_attribute ) ) .
                value as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_value_attribute ) , "::" , stringify ! ( value
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_value_attribute ) ) .
                match_ as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_value_attribute ) , "::" , stringify ! (
                match_ ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_value_attribute ) ) .
                mod_ as * const _ as usize } , 12usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_value_attribute ) , "::" , stringify ! ( mod_
                ) ));
}
impl Clone for mycss_selectors_value_attribute {
    fn clone(&self) -> Self { *self }
}
pub type mycss_selectors_object_attribute_t = mycss_selectors_value_attribute;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mycss_selectors_value_lang {
    pub str: mycore_string_t,
    pub next: *mut mycss_selectors_value_lang,
}
#[test]
fn bindgen_test_layout_mycss_selectors_value_lang() {
    assert_eq!(::std::mem::size_of::<mycss_selectors_value_lang>() , 48usize ,
               concat ! (
               "Size of: " , stringify ! ( mycss_selectors_value_lang ) ));
    assert_eq! (::std::mem::align_of::<mycss_selectors_value_lang>() , 8usize
                , concat ! (
                "Alignment of " , stringify ! ( mycss_selectors_value_lang )
                ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_value_lang ) ) . str as *
                const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_value_lang ) , "::" , stringify ! ( str ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_value_lang ) ) . next as
                * const _ as usize } , 40usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_value_lang ) , "::" , stringify ! ( next ) ));
}
impl Clone for mycss_selectors_value_lang {
    fn clone(&self) -> Self { *self }
}
pub type mycss_selectors_value_lang_t = mycss_selectors_value_lang;
extern "C" {
    pub fn mycss_selectors_value_undef_create(entry: *mut mycss_entry_t,
                                              set_clean: bool)
     -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn mycss_selectors_value_attribute_create(entry: *mut mycss_entry_t,
                                                  set_clean: bool)
     -> *mut mycss_selectors_object_attribute_t;
}
extern "C" {
    pub fn mycss_selectors_value_undef_destroy(entry: *mut mycss_entry_t,
                                               type_: mycss_selectors_type_t,
                                               sub_type:
                                                   ::std::os::raw::c_int,
                                               value:
...
extern "C" {
    pub fn mycss_selectors_value_id_destroy(entry: *mut mycss_entry_t,
                                            type_: mycss_selectors_type_t,
                                            sub_type: ::std::os::raw::c_int,
                                            value:
                                                *mut ::std::os::raw::c_void,
                                            self_destroy: bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_class_destroy(entry: *mut mycss_entry_t,
                                               type_: mycss_selectors_type_t,
                                               sub_type:
                                                   ::std::os::raw::c_int,
                                               value:
...
extern "C" {
    pub fn mycss_selectors_value_element_destroy(entry: *mut mycss_entry_t,
                                                 type_:
...
extern "C" {
    pub fn mycss_selectors_value_attribute_destroy(entry: *mut mycss_entry_t,
                                                   type_:
                                                       mycss_selectors_type_t,
                                                   sub_type:
                                                       ::std::os::raw::c_int,
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_destroy(entry:
                                                                   *mut mycss_entry_t,
                                                               type_:
                                                                   mycss_selectors_type_t,
                                                               sub_type:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_undef_create(entry:
                                                                        *mut mycss_entry_t,
                                                                    set_clean:
                                                                        bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_current_create(entry:
                                                                          *mut mycss_entry_t,
                                                                      set_clean:
                                                                          bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_dir_create(entry:
                                                                      *mut mycss_entry_t,
                                                                  set_clean:
                                                                      bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_drop_create(entry:
                                                                       *mut mycss_entry_t,
                                                                   set_clean:
                                                                       bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_has_create(entry:
                                                                      *mut mycss_entry_t,
                                                                  set_clean:
                                                                      bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_lang_create(entry:
                                                                       *mut mycss_entry_t,
                                                                   set_clean:
                                                                       bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_matches_create(entry:
                                                                          *mut mycss_entry_t,
                                                                      set_clean:
                                                                          bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_not_create(entry:
                                                                      *mut mycss_entry_t,
                                                                  set_clean:
                                                                      bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_child_create(entry:
                                                                            *mut mycss_entry_t,
                                                                        set_clean:
                                                                            bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_column_create(entry:
                                                                             *mut mycss_entry_t,
                                                                         set_clean:
                                                                             bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_child_create(entry:
                                                                                 *mut mycss_entry_t,
                                                                             set_clean:
                                                                                 bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_column_create(entry:
                                                                                  *mut mycss_entry_t,
                                                                              set_clean:
                                                                                  bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_of_type_create(entry:
                                                                                   *mut mycss_entry_t,
                                                                               set_clean:
                                                                                   bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_of_type_create(entry:
                                                                              *mut mycss_entry_t,
                                                                          set_clean:
                                                                              bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_undef_destroy(entry:
                                                                         *mut mycss_entry_t,
                                                                     value:
                                                                         *mut ::std::os::raw::c_void,
                                                                     self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_current_destroy(entry:
                                                                           *mut mycss_entry_t,
                                                                       value:
                                                                           *mut ::std::os::raw::c_void,
                                                                       self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_dir_destroy(entry:
                                                                       *mut mycss_entry_t,
                                                                   value:
                                                                       *mut ::std::os::raw::c_void,
                                                                   self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_drop_destroy(entry:
                                                                        *mut mycss_entry_t,
                                                                    value:
                                                                        *mut ::std::os::raw::c_void,
                                                                    self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_has_destroy(entry:
                                                                       *mut mycss_entry_t,
                                                                   value:
                                                                       *mut ::std::os::raw::c_void,
                                                                   self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_lang_destroy(entry:
                                                                        *mut mycss_entry_t,
                                                                    value:
                                                                        *mut ::std::os::raw::c_void,
                                                                    self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_matches_destroy(entry:
                                                                           *mut mycss_entry_t,
                                                                       value:
                                                                           *mut ::std::os::raw::c_void,
                                                                       self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_not_destroy(entry:
                                                                       *mut mycss_entry_t,
                                                                   value:
                                                                       *mut ::std::os::raw::c_void,
                                                                   self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_child_destroy(entry:
                                                                             *mut mycss_entry_t,
                                                                         value:
                                                                             *mut ::std::os::raw::c_void,
                                                                         self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_column_destroy(entry:
                                                                              *mut mycss_entry_t,
                                                                          value:
                                                                              *mut ::std::os::raw::c_void,
                                                                          self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_child_destroy(entry:
                                                                                  *mut mycss_entry_t,
                                                                              value:
                                                                                  *mut ::std::os::raw::c_void,
                                                                              self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_column_destroy(entry:
                                                                                   *mut mycss_entry_t,
                                                                               value:
                                                                                   *mut ::std::os::raw::c_void,
                                                                               self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_last_of_type_destroy(entry:
                                                                                    *mut mycss_entry_t,
                                                                                value:
                                                                                    *mut ::std::os::raw::c_void,
                                                                                self_destroy:
...
extern "C" {
    pub fn mycss_selectors_value_pseudo_class_function_nth_of_type_destroy(entry:
                                                                               *mut mycss_entry_t,
                                                                           value:
                                                                               *mut ::std::os::raw::c_void,
                                                                           self_destroy:
...
extern "C" {
    pub fn mycss_selectors_function_parser_state_drop_component_value(entry:
                                                                          *mut mycss_entry_t,
                                                                      token:
                                                                          *mut mycss_token_t,
                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_unknown_parser(entry: *mut mycss_entry_t,
                                          token: *mut mycss_token_t,
                                          last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_function_parser_not_or_matches_or_current_parser(entry:
                                                                                *mut mycss_entry_t,
                                                                            token:
                                                                                *mut mycss_token_t,
                                                                            last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_has(entry: *mut mycss_entry_t,
                                               token: *mut mycss_token_t,
                                               last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_function_parser_nth_with_selectors(entry:
                                                                  *mut mycss_entry_t,
                                                              token:
                                                                  *mut mycss_token_t,
                                                              last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_nth_with_selectors_need_of(entry:
                                                                          *mut mycss_entry_t,
                                                                      token:
                                                                          *mut mycss_token_t,
                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_nth_with_selectors_need_of_after(entry:
                                                                                *mut mycss_entry_t,
                                                                            token:
                                                                                *mut mycss_token_t,
                                                                            last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_nth_without_selectors(entry:
                                                                     *mut mycss_entry_t,
                                                                 token:
                                                                     *mut mycss_token_t,
                                                                 last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_nth_without_selectors_after(entry:
                                                                           *mut mycss_entry_t,
                                                                       token:
                                                                           *mut mycss_token_t,
                                                                       last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_drop(entry: *mut mycss_entry_t,
                                                token: *mut mycss_token_t,
                                                last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_function_parser_drop_after(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t,
                                                      last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_function_parser_drop_after_column(entry:
                                                                 *mut mycss_entry_t,
                                                             token:
                                                                 *mut mycss_token_t,
                                                             last_response:
...
extern "C" {
    pub fn mycss_selectors_function_parser_dir(entry: *mut mycss_entry_t,
                                               token: *mut mycss_token_t,
                                               last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_function_parser_dir_after(entry:
                                                         *mut mycss_entry_t,
                                                     token:
                                                         *mut mycss_token_t,
                                                     last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_function_parser_lang(entry: *mut mycss_entry_t,
                                                token: *mut mycss_token_t,
                                                last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_function_parser_lang_after(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t,
                                                      last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_function_parser_lang_comma(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t,
                                                      last_response: bool)
...
pub type mycss_selectors_function_begin_f =
    ::std::option::Option<unsafe extern "C" fn(entry: *mut mycss_entry_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t)>;
#[repr(C)]
#[derive(Debug, Copy)]
pub struct mycss_selectors_function_index {
    pub parser: mycss_parser_token_f,
    pub switch_parser: mycss_parser_token_f,
}
#[test]
fn bindgen_test_layout_mycss_selectors_function_index() {
    assert_eq!(::std::mem::size_of::<mycss_selectors_function_index>() ,
               16usize , concat ! (
               "Size of: " , stringify ! ( mycss_selectors_function_index )
               ));
    assert_eq! (::std::mem::align_of::<mycss_selectors_function_index>() ,
                8usize , concat ! (
                "Alignment of " , stringify ! ( mycss_selectors_function_index
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_function_index ) ) .
                parser as * const _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_function_index ) , "::" , stringify ! ( parser
                ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const mycss_selectors_function_index ) ) .
                switch_parser as * const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! (
                mycss_selectors_function_index ) , "::" , stringify ! (
                switch_parser ) ));
}
impl Clone for mycss_selectors_function_index {
    fn clone(&self) -> Self { *self }
}
pub type mycss_selectors_function_index_t = mycss_selectors_function_index;
extern "C" {
    pub fn mycss_selectors_function_begin_nth_child(entry: *mut mycss_entry_t,
                                                    selector:
                                                        *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_not(entry: *mut mycss_entry_t,
                                              selector:
                                                  *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_dir(entry: *mut mycss_entry_t,
                                              selector:
                                                  *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_matches(entry: *mut mycss_entry_t,
                                                  selector:
                                                      *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_lang(entry: *mut mycss_entry_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_drop(entry: *mut mycss_entry_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_nth_of_type(entry:
                                                          *mut mycss_entry_t,
                                                      selector:
                                                          *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_nth_last_column(entry:
                                                              *mut mycss_entry_t,
                                                          selector:
                                                              *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_current(entry: *mut mycss_entry_t,
                                                  selector:
                                                      *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_nth_last_child(entry:
                                                             *mut mycss_entry_t,
                                                         selector:
                                                             *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_nth_last_of_type(entry:
                                                               *mut mycss_entry_t,
                                                           selector:
                                                               *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_has(entry: *mut mycss_entry_t,
                                              selector:
                                                  *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_function_begin_nth_column(entry:
                                                         *mut mycss_entry_t,
                                                     selector:
                                                         *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_begin_unknown(entry: *mut mycss_entry_t,
                                         selector:
                                             *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_begin(entry: *mut mycss_entry_t,
                                                 token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_ident_type(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_ident_attr(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_namespace_ident(entry:
                                                               *mut mycss_entry_t,
                                                           token:
                                                               *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_namespace_attr(entry:
                                                              *mut mycss_entry_t,
                                                          token:
                                                              *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_after_namespace(entry:
                                                               *mut mycss_entry_t,
                                                           token:
                                                               *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_id(entry: *mut mycss_entry_t,
                                              token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_class(entry: *mut mycss_entry_t,
                                                 token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_value(entry: *mut mycss_entry_t,
                                                 token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_end(entry: *mut mycss_entry_t,
                                               token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_modifier(entry: *mut mycss_entry_t,
                                                    token:
                                                        *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_class(entry:
                                                            *mut mycss_entry_t,
                                                        token:
                                                            *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_class_function(entry:
                                                                     *mut mycss_entry_t,
                                                                 token:
                                                                     *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_class_function_end(entry:
                                                                         *mut mycss_entry_t,
                                                                     token:
                                                                         *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_element(entry:
                                                              *mut mycss_entry_t,
                                                          token:
                                                              *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_element_function(entry:
                                                                       *mut mycss_entry_t,
                                                                   token:
                                                                       *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_selector_pseudo_element_function_end(entry:
                                                                           *mut mycss_entry_t,
                                                                       token:
                                                                           *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_expectations_error(entry:
                                                         *mut mycss_entry_t,
                                                     token:
                                                         *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_bad_token(entry: *mut mycss_entry_t,
                                            token: *mut mycss_token_t);
}
extern "C" {
    pub fn mycss_selectors_parser_check_and_set_bad_parent_selector(entry:
                                                                        *mut mycss_entry_t,
                                                                    selectors_list:
                                                                        *mut mycss_selectors_list_t);
}
extern "C" {
    pub fn mycss_selectors_state_end(entry: *mut mycss_entry_t);
}
extern "C" {
    pub fn mycss_selectors_state_function_skip_all(entry: *mut mycss_entry_t,
                                                   token: *mut mycss_token_t,
                                                   last_response: bool)
     -> bool;
}
extern "C" {
    pub fn mycss_selectors_state_drop(entry: *mut mycss_entry_t,
                                      token: *mut mycss_token_t,
                                      last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_state_drop_component_value(entry:
                                                          *mut mycss_entry_t,
                                                      token:
                                                          *mut mycss_token_t,
                                                      last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_combinator(entry: *mut mycss_entry_t,
                                            token: *mut mycss_token_t,
                                            last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_state_combinator_greater_than(entry:
                                                             *mut mycss_entry_t,
                                                         token:
                                                             *mut mycss_token_t,
                                                         last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_complex_selector_list(entry:
                                                           *mut mycss_entry_t,
                                                       token:
                                                           *mut mycss_token_t,
                                                       last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_complex_selector_list_need_combinator_or_selector(entry:
                                                                                       *mut mycss_entry_t,
                                                                                   token:
                                                                                       *mut mycss_token_t,
                                                                                   last_response:
...
extern "C" {
    pub fn mycss_selectors_state_complex_selector_list_need_combinator_or_selector_ws(entry:
                                                                                          *mut mycss_entry_t,
                                                                                      token:
                                                                                          *mut mycss_token_t,
                                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_state_complex_selector_list_need_selector(entry:
                                                                         *mut mycss_entry_t,
                                                                     token:
                                                                         *mut mycss_token_t,
                                                                     last_response:
...
extern "C" {
    pub fn mycss_selectors_state_complex_selector_list_need_comma(entry:
                                                                      *mut mycss_entry_t,
                                                                  token:
                                                                      *mut mycss_token_t,
                                                                  last_response:
...
extern "C" {
    pub fn mycss_selectors_state_compound_selector_list(entry:
                                                            *mut mycss_entry_t,
                                                        token:
                                                            *mut mycss_token_t,
                                                        last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_compound_selector_list_need_selector(entry:
                                                                          *mut mycss_entry_t,
                                                                      token:
                                                                          *mut mycss_token_t,
                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_state_compound_selector_list_need_selector_or_comma(entry:
                                                                                   *mut mycss_entry_t,
                                                                               token:
                                                                                   *mut mycss_token_t,
                                                                               last_response:
...
extern "C" {
    pub fn mycss_selectors_state_compound_selector_list_comma_ws(entry:
                                                                     *mut mycss_entry_t,
                                                                 token:
                                                                     *mut mycss_token_t,
                                                                 last_response:
...
extern "C" {
    pub fn mycss_selectors_state_compound_selector_list_need_ending_or_comma(entry:
                                                                                 *mut mycss_entry_t,
                                                                             token:
                                                                                 *mut mycss_token_t,
                                                                             last_response:
...
extern "C" {
    pub fn mycss_selectors_state_relative_selector_list(entry:
                                                            *mut mycss_entry_t,
                                                        token:
                                                            *mut mycss_token_t,
                                                        last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_relative_selector_list_need_selector(entry:
                                                                          *mut mycss_entry_t,
                                                                      token:
                                                                          *mut mycss_token_t,
                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_state_relative_selector_list_need_combinator_or_selector_begin(entry:
                                                                                              *mut mycss_entry_t,
                                                                                          token:
                                                                                              *mut mycss_token_t,
                                                                                          last_response:
...
extern "C" {
    pub fn mycss_selectors_state_relative_selector_list_need_combinator_or_selector(entry:
                                                                                        *mut mycss_entry_t,
                                                                                    token:
                                                                                        *mut mycss_token_t,
                                                                                    last_response:
...
extern "C" {
    pub fn mycss_selectors_state_relative_selector_list_need_combinator_or_selector_ws(entry:
                                                                                           *mut mycss_entry_t,
                                                                                       token:
                                                                                           *mut mycss_token_t,
                                                                                       last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_begin(entry:
                                                           *mut mycss_entry_t,
                                                       token:
                                                           *mut mycss_token_t,
                                                       last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector(entry: *mut mycss_entry_t,
                                                 token: *mut mycss_token_t,
                                                 last_response: bool) -> bool;
}
extern "C" {
    pub fn mycss_selectors_state_simple_selector_left_bracket(entry:
                                                                  *mut mycss_entry_t,
                                                              token:
                                                                  *mut mycss_token_t,
                                                              last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_left_bracket_vertical_bar(entry:
                                                                               *mut mycss_entry_t,
                                                                           token:
                                                                               *mut mycss_token_t,
                                                                           last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_left_bracket_ident(entry:
                                                                        *mut mycss_entry_t,
                                                                    token:
                                                                        *mut mycss_token_t,
                                                                    last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_left_bracket_ident_vertical_bar(entry:
                                                                                     *mut mycss_entry_t,
                                                                                 token:
                                                                                     *mut mycss_token_t,
                                                                                 last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_colon(entry:
                                                           *mut mycss_entry_t,
                                                       token:
                                                           *mut mycss_token_t,
                                                       last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_colon_colon(entry:
                                                                 *mut mycss_entry_t,
                                                             token:
                                                                 *mut mycss_token_t,
                                                             last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_colon_colon_function(entry:
                                                                          *mut mycss_entry_t,
                                                                      token:
                                                                          *mut mycss_token_t,
                                                                      last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_colon_function(entry:
                                                                    *mut mycss_entry_t,
                                                                token:
                                                                    *mut mycss_token_t,
                                                                last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_full_stop(entry:
                                                               *mut mycss_entry_t,
                                                           token:
                                                               *mut mycss_token_t,
                                                           last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_vertical_bar(entry:
                                                                  *mut mycss_entry_t,
                                                              token:
                                                                  *mut mycss_token_t,
                                                              last_response:
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_ident(entry:
                                                           *mut mycss_entry_t,
                                                       token:
                                                           *mut mycss_token_t,
                                                       last_response: bool)
...
extern "C" {
    pub fn mycss_selectors_state_simple_selector_ident_vertical_bar(entry:
                                                                        *mut mycss_entry_t,
                                                                    token:
                                                                        *mut mycss_token_t,
                                                                    last_response:
...
extern "C" {
    pub fn mycss_selectors_state_shared_after_attr_modifier(entry:
                                                                *mut mycss_entry_t,
                                                            token:
                                                                *mut mycss_token_t,
                                                            last_response:
...
extern "C" {
    pub fn mycss_selectors_state_shared_after_attribute_value(entry:
                                                                  *mut mycss_entry_t,
                                                              token:
                                                                  *mut mycss_token_t,
                                                              last_response:
...
extern "C" {
    pub fn mycss_selectors_state_left_bracket_after_wq_name_attr(entry:
                                                                     *mut mycss_entry_t,
                                                                 token:
                                                                     *mut mycss_token_t,
                                                                 last_response:
...
extern "C" {
    pub fn mycss_selectors_state_shared_after_attr_matcher(entry:
                                                               *mut mycss_entry_t,
                                                           token:
                                                               *mut mycss_token_t,
                                                           last_response:
...
extern "C" {
    pub fn mycss_selectors_serialization_chain(selectors:
                                                   *mut mycss_selectors_t,
                                               selector:
                                                   *mut mycss_selectors_entry_t,
                                               callback:
...
extern "C" {
    pub fn mycss_selectors_serialization_list(selectors:
                                                  *mut mycss_selectors_t,
                                              selectors_list:
                                                  *mut mycss_selectors_list_t,
                                              callback:
...
extern "C" {
    pub fn mycss_selectors_serialization_selector(selectors:
                                                      *mut mycss_selectors_t,
                                                  selector:
                                                      *mut mycss_selectors_entry_t,
                                                  callback:
...
extern "C" {
    pub fn mycss_selectors_list_create(selectors: *mut mycss_selectors_t)
     -> *mut mycss_selectors_list_t;
}
extern "C" {
    pub fn mycss_selectors_list_clean(selector_list:
                                          *mut mycss_selectors_list_t);
}
extern "C" {
    pub fn mycss_selectors_list_destroy(selectors: *mut mycss_selectors_t,
                                        selector_list:
                                            *mut mycss_selectors_list_t,
                                        self_destroy: bool)
     -> *mut mycss_selectors_list_t;
...
extern "C" {
    pub fn mycss_selectors_list_append_selector(selectors:
                                                    *mut mycss_selectors_t,
                                                selector_list:
                                                    *mut mycss_selectors_list_t,
                                                selector:
...
extern "C" {
    pub fn mycss_selectors_list_last_entry(list: *mut mycss_selectors_list_t)
     -> *mut mycss_selectors_entry_t;
}
extern "C" {
    pub fn mycss_selectors_list_current_chain(list:
                                                  *mut mycss_selectors_list_t)
     -> *mut *mut mycss_selectors_entry_t;
}
extern "C" {
    pub fn mycss_selectors_list_append_to_current(selectors:
                                                      *mut mycss_selectors_t,
                                                  current_list:
                                                      *mut mycss_selectors_list_t);
}
extern "C" {
    pub fn mycss_selectors_list_destroy_last_empty_selector(selectors:
                                                                *mut mycss_selectors_t,
                                                            list:
                                                                *mut mycss_selectors_list_t,
                                                            destroy_found:
...
extern "C" {
    pub fn mycss_selectors_create() -> *mut mycss_selectors_t;
}
extern "C" {
    pub fn mycss_selectors_init(entry: *mut mycss_entry_t,
                                selectors: *mut mycss_selectors_t)
     -> mystatus_t;
}
extern "C" {
    pub fn mycss_selectors_clean(selectors: *mut mycss_selectors_t);
}
extern "C" {
    pub fn mycss_selectors_clean_all(selectors: *mut mycss_selectors_t)
     -> mystatus_t;
}
extern "C" {
    pub fn mycss_selectors_destroy(selectors: *mut mycss_selectors_t,
                                   self_destroy: bool)
     -> *mut mycss_selectors_t;
}
extern "C" {
    pub fn mycss_selectors_entry_clean(sel_entry:
                                           *mut mycss_selectors_entry_t);
}
extern "C" {
    pub fn mycss_selectors_entry_destroy(selectors: *mut mycss_selectors_t,
                                         selector:
                                             *mut mycss_selectors_entry_t,
                                         self_destroy: bool)
     -> *mut mycss_selectors_entry_t;
...
extern "C" {
    pub fn mycss_selectors_entry_value_destroy(entry: *mut mycss_entry_t,
                                               selector_entry:
                                                   *mut mycss_selectors_entry_t,
                                               destroy_self: bool)
     -> *mut ::std::os::raw::c_void;
...
extern "C" {
    pub fn mycss_selectors_parse(selectors: *mut mycss_selectors_t,
                                 encoding: myencoding_t,
                                 data: *const ::std::os::raw::c_char,
                                 data_size: usize,
                                 out_status: *mut mystatus_t)
     -> *mut mycss_selectors_list_t;
}
extern "C" {
    pub fn mycss_selectors_parse_by_function(selectors:
                                                 *mut mycss_selectors_t,
                                             func: mycss_parser_token_f,
                                             encoding: myencoding_t,
                                             data:
                                                 *const ::std::os::raw::c_char,
                                             data_size: usize,
...
extern "C" {
    pub fn mycss_selectors_entry_find_first(selector:
                                                *mut mycss_selectors_entry_t)
     -> *mut mycss_selectors_entry_t;
}
extern "C" {
    pub fn mycss_selectors_entry_create(selectors: *mut mycss_selectors_t)
     -> *mut mycss_selectors_entry_t;
}
extern "C" {
    pub fn mycss_selectors_entries_list_create(selectors:
                                                   *mut mycss_selectors_t)
     -> *mut mycss_selectors_entries_list_t;
}
extern "C" {
    pub fn mycss_selectors_entries_list_add_one(selectors:
                                                    *mut mycss_selectors_t,
                                                entries:
                                                    *mut mycss_selectors_entries_list_t,
                                                current_size: usize)
...
extern "C" {
    pub fn mycss_selectors_entries_list_destroy(selectors:
                                                    *mut mycss_selectors_t,
                                                entries:
                                                    *mut mycss_selectors_entries_list_t)
     -> *mut mycss_selectors_entries_list_t;
...
extern "C" {
    pub fn mycss_selectors_entry(selectors: *mut mycss_selectors_t)
     -> *mut mycss_selectors_entry_t;
}
extern "C" {
    pub fn mycss_selectors_entry_append_to_current(selectors:
                                                       *mut mycss_selectors_t,
                                                   selector:
                                                       *mut mycss_selectors_entry_t);
}
